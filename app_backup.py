        ...
        while True:
            ...
            while True:
                ...
                try:
                    ...
                    self.on_new_message("Connection attempt: " +str(counter) + ", timed out, retrying in 1 second...")
                    time.sleep(1)
...
class MQTTThread(QRunnable):
    ...
    def on_message(self, client, userdata, message):
        ...
        # print(parsed_data)
        # if parse data is empty, show a message in the status text box
        if not parsed_data:
            self.on_new_message("No data received from MQTT broker")
            return
